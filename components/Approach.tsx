...
const Approach = () => {
  return (
    <section className="w-full py-20 max-md:py-10">
      <h1 className="heading">
        My <span className="text-deepgreen-accent"> approach</span>
      </h1>
  ...
  return (
    <div>
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-deepgreen-surface px-5 py-2 font-bold text-white backdrop-blur-3xl text-2xl">
          {order}
        </span>
      </button>
    </div>
